...
<div class="hero-slider">
    <!-- Slider Item -->
    <div class="slider-item slide1" style="background-image:url(<?php echo base_url(); ?>theme/images/slider/kemendag.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start -->
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-xs-12">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="item">
								...
								<h6>DIT. Pemberdayaan Konsumen</h6>
								<p>1. Struktur Organisasi
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                              ...
                              <i><font style="font-size: 14px; font-family: 'Source Sans Pro', sans-serif;"> lihat selengkapnya .. </font></i> 
                            </td>
                        </tr>
                      </table>
                </p>
                <p>2. Fungsi dan Tugas
                      <br>
                      
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                              <font style="font-size: 14px; font-family: 'Source Sans Pro', sans-serif;">
                ...
                <p style="margin-top: 0%;">5. Kontak Pejabat
                      <br>
              ...
              <div class="item">
                ...
                <p>2. Fungsi dan Tugas
                      ...
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                              <font style="font-size: 14px; font-family: 'Source Sans Pro', sans-serif;">
                                  Direktorat Metrologi mempunyai tugas melaksanakan perumusan, pelaksanaan dan pengendalian kebijakan, penyusunan pedoman ... <br/>
                              </font>
                ...
                <p style="margin-top: 0%;">3. Kontak Pejabat
                      <br>
                        ...
                        <tr>
                            <td align="justify">
                              <font style="font-size: 14px; font-family: 'Source Sans Pro', sans-serif;">
                                ...
                                Jl.Pasteur No. 27 Bandung<br/>
                                Telp : (022) 4203 597<br/>
                                Fax: (022) 4207035<br/>
                              </font>
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#dormitory"  data-toggle="tab">DIT. Pemerdayaan Konsumen</a>
                            </li>
...
<footer class="footer-main">
  ...
  <div class="footer-bottom">
    <div class="container clearfix">
      ...
      <div class="copyright-text" style="margin-top: 15%;">
        <p>&copy; Copyright 2018. All Rights Reserved by
          <a href="index.html">Medic</a>
        </p>
      </div>
      <ul class="footer-bottom-link" style="margin-top: 15%;">
        <li>
          <a href="index.html">Home</a>
        </li>
        <li>
    ...
    <div class="modal-content">
      <form action="" method="post">
        ...
        <div class="modal-footer">
          ...
          <input type="button" class="btn btn-primary pull-right" value="Login" onclick="login1()">
        </div>
      </form>
    </div>
  </div>
