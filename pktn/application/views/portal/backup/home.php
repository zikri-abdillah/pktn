      ...
      <div class="col-sm-12 col-xs-12">
        <div class="image-content">
          <div class="section-title text-center" style="margin-top: -4%;">
            <h3 style="font-size: 40px">Direktorat Jenderal PKTN
              <!-- <span>of Our Hospital</span> -->
            </h3>
            <p style="font-size: 14px;margin-top: -1%;">Direktorat Jenderal Perlindungan Konsumen dan Tertib Niaga - <br>
          ...
          <div class="row" style="margin-top: 4%; color: #2e2d2d">
            <div class="col-sm-6">
              <div class="item">
                ...
                <h6 style="font-size: 15.5px;"><b>Direktorat. Pemberdayaan</b></h6>
                <p style="margin-top: 2%;"><span style="font-size: 16px;">1. Struktur Organisasi</span>
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                              ...
                              <i><font style="font-size: 15px; font-family: 'Source Sans Pro', sans-serif;"> lihat selengkapnya .. </font></i> 
                            </td>
                        </tr>
                      </table>
                </p>
                <p style="margin-top: 5%;"><span style="font-size: 16px;">2. Fungsi dan Tugas</span>
                      <br>
                      
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                              <font style="font-size: 15px; font-family: 'Source Sans Pro', sans-serif;">
                ...
                <p style="margin-top: 5.5%;"><span style="font-size: 16px;">3. LPKSM</span>
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                ...
                <p style="margin-top: 5.5%;"><span style="font-size: 16px">4. BPSK</span>
                      <br>
                ...
                <p style="margin-top: 5.5%;"><span style="font-size: 16px;">5. Kontak Pejabat</span>
                      <br>
                ...
                <div style="margin-top: 3%;">
                  <h6 style="font-size: 15.5px;"><b>Direktorat. Pengawasan</b></h6>
                <p style="margin-top: 2%;"><span style="font-size: 15px;">1. Struktur Organisasi</span>
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                ...
                <p style="margin-top: 5.5%;"><span style="font-size: 16px;">3. Kontak Pejabat</span>
                      <br>
                ...
                <div style="margin-top: 3%;">
                  <h6 style="font-size: 15.5px;"><b>Direktorat. Standalitu</b></h6>
                <p style="margin-top: 2%;"><span style="font-size: 16px;">1. Struktur Organisasi</span>
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                ...
                <p style="margin-top: 5.5%;"><span style="font-size: 16px;">3. Pelayanan Standalitu</span>
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                              <font style="font-size: 15px; font-family: 'Source Sans Pro', sans-serif;">
                                 Pelayanan standalitu ada BPSM, Kalibrasi, TPP, NRP, NPB, LPK dan lain-lainnya <br/>
                              </font>
                ...
                <p style="margin-top: 5.5%;"><span style="font-size: 16px">4. Kebijakan Dan Sasaran Mutu</span>
                      <br>
            ...
            <div class="col-sm-6" style="margin-top: 0%;">
              <div class="item">
                ...
                <div style=" margin-left: 0%">
                  <h6 style="font-size: 15.5px;"><b>Direktorat. Metrologi</b></h6>
                <p style="margin-top: 2%;"><span style="font-size: 16px;">1. Struktur Organisasi</span>
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                ...
                <p style="margin-top: 5.5%;"><span style="font-size: 16px;">3. Syarat Teknis UTP</span>
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                              <font style="font-size: 15px; font-family: 'Source Sans Pro', sans-serif;">
                                  Adapun Syarat dan Teknis UTP sebagai berikut ST Alat Ukur Panjang ... <br/>
                              </font>
                ...
                <p style="margin-top: 5%;"><span style="font-size: 16px">4. Data Tera dan Tera Ulang UTTP Kab/Kota Th 2017-2018</span>
                      <br>
                    ...
                    <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
                            <td align="justify">
                              <font style="font-size: 15px; font-family: 'Source Sans Pro', sans-serif;">
                                 Adapun Data Tera dan Tera Ulang UTTP Kabupaten/Kota Tahun 2017 - 2018 ... <br/>
                              </font>
            ...
            <div class="col-sm-6" style="margin-top: -3.9%;">
              <div class="item">
                ...
                <div style=" margin-left: 0%">
                  <h6 style="font-size: 15.5px;"><b>Direktorat. Tertib Niaga</b></h6>
                    <p style="margin-top: 2%;"><span style="font-size: 16px;">1. Struktur Organisasi</span>
                      <br>
                      <table border="0" width="100%" style="margin-left: 3%;margin-top: -2%">
                        <tr>
        ...
        <div class="row items-container clearfix">
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="<?php echo base_url(); ?>theme/images/gallery/edukasi-1.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="<?php echo base_url(); ?>theme/images/gallery/SNI.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <!-- <span>Better Service At Low Cost</span> -->
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="<?php echo base_url(); ?>theme/images/gallery/pers.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <!-- <span>Better Service At Low Cost</span> -->
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="<?php echo base_url(); ?>theme/images/gallery/regulasi.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <!-- <span>Better Service At Low Cost</span> -->
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="<?php echo base_url(); ?>theme/images/gallery/agenda.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <!-- <span>Better Service At Low Cost</span> -->
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="<?php echo base_url(); ?>theme/images/gallery/peraturan.jpg" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <!-- <span>Better Service At Low Cost</span> -->
...
<section class="appoinment-section section" >
    ...
    <div class="accordion-holder">
        <div class="panel-group" id="accordion_faq" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel-heading" role="tab" id="headingFour_faq">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_faq" href="#collapseFour_faq" aria-expanded="false"
                            ...
                            <span style="font-size: 18px; text-align: justify;"> Bagaimana caranya saya bisa mendapatkan hak akses  PKTN ? </span>
                        </a>
                    </h4>
                </div>
                    ...
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_faq" href="#collapseTwo_faq" aria-expanded="false"
                            aria-controls="collapseTwo_faq">
                             <span style="font-size: 18px;"> Data perusahaan apa saja yang harus di isi oleh perusahaan ? </span>
                        </a>
                    </h4>
                </div>
                ...
                <div class="panel-heading" role="tab" id="headingThree_faq">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_faq" href="#collapseThree_faq" aria-expanded="false"
                            ...
                            <span style="font-size: 18px;">Dokument Pendukung apa saja yang digunakan untuk registrasi PKTN ? </span>
                        </a>
                    </h4>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingFive_faq">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_faq" href="#collapseFive_faq" aria-expanded="false"
                            aria-controls="collapseFive_faq">
                            <span style="font-size: 18px;">Bagaimana jika saya diluar jakarta ? </span>
                        </a>
                    </h4>
                </div>
                <div id="collapseFive_faq" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive_faq">
                    <div class="panel-body" style="text-align: justify;">
                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute,
                        non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor,
                        sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingSix_faq">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_faq" href="#collapseSix_faq" aria-expanded="false"
                            aria-controls="collapseSix_faq">
                            <span style="font-size: 18px;">Berapa lama saya bisa mendapatkan hak akses ? </span>
                        </a>
                    </h4>
                </div>
                <div id="collapseSix_faq" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix_faq">
                    <div class="panel-body" style="text-align: justify;">
                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute,
                        non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor,
                        sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingSeven_faq">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_faq" href="#collapseSeven_faq" aria-expanded="false"
                            aria-controls="collapseSeven_faq">
                            <span style="font-size: 18px;">Bagaimana cara saa login di PKTN ? </span>
                        </a>
                    </h4>
                </div>
                <div id="collapseSeven_faq" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven_faq">
                    <div class="panel-body" style="text-align: justify;">
                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute,
                        non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor,
                        sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh
