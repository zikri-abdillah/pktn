            ...
            <div class="row">
                <div class="col-12">
                   ...
                   <!--  <div class="content style text-center"> -->
                       <!--  <h2 class="text-white text-bold mb-2">Peraturan-Peraturan <br></h2>
                        <h2 class="text-white text-bold mb-2">DJPKTN</h2>
                        <p class="tag-text mb-5">pertanyaan yang sering diajukan <br> -->
  ...
  <table class="table" style=" color: #000">
    <thead>
      <tr bgcolor="#0d1a2f" style="color: #fff">
        ...
        <th colspan="4"><center>Peraturan</center></th>
    ...
    <tbody>
      <tr>
        ...
        <td align="center"> <a href="http://e-ska.kemendag.go.id/uploads/2PERMENDAG.pdf" target="_blank">+ Selengkapnya</a></td>
      </tr>
      <tr bgcolor="#ebe6e6">
